This project is a weather app built with HTML, CSS, and JavaScript. The user can search a city in the search bar and data from two API's will be displayed on the screen.
